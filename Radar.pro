...
RadarRootPath=/media/bat/SecondSSD/Projects/Unreal/Radar

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/Radar/Radar.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(RadarSource.pri)
include(RadarHeader.pri)
include(RadarConfig.pri)
include(RadarIncludes.pri)
include(RadarDefines.pri)
...
Radar-Linux-Debug.commands = $$build Radar Linux Debug  -project="\"$$gameProjectFile\"" $$args
Radar-Linux-DebugGame.commands = $$build Radar Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Radar-Linux-Shipping.commands = $$build Radar Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Radar-Linux-Test.commands = $$build Radar Linux Test  -project="\"$$gameProjectFile\"" $$args
Radar.commands = $$build Radar Linux Development  -project="\"$$gameProjectFile\"" $$args

RadarEditor-Linux-Debug.commands = $$build RadarEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
RadarEditor-Linux-DebugGame.commands = $$build RadarEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
RadarEditor-Linux-Shipping.commands = $$build RadarEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
RadarEditor-Linux-Test.commands = $$build RadarEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
RadarEditor.commands = $$build RadarEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Radar-Linux-Debug \
	Radar-Linux-DebugGame \
	Radar-Linux-Shipping \
	Radar-Linux-Test \
	Radar \
	RadarEditor-Linux-Debug \
	RadarEditor-Linux-DebugGame \
	RadarEditor-Linux-Shipping \
	RadarEditor-Linux-Test \
	RadarEditor \
