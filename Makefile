...
Radar-Linux-Debug:
	 $(PROJECTBUILD) Radar Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Radar-Linux-DebugGame:
	 $(PROJECTBUILD) Radar Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Radar-Linux-Shipping:
	 $(PROJECTBUILD) Radar Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Radar-Linux-Test:
	 $(PROJECTBUILD) Radar Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Radar:
	 $(PROJECTBUILD) Radar Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RadarEditor-Linux-Debug:
	 $(PROJECTBUILD) RadarEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RadarEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RadarEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RadarEditor-Linux-Shipping:
	 $(PROJECTBUILD) RadarEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RadarEditor-Linux-Test:
	 $(PROJECTBUILD) RadarEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RadarEditor:
	 $(PROJECTBUILD) RadarEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
